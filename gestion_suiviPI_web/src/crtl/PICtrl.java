...
public class PICtrl {
	...
	public void getProxy(){
		...
		try {
			...
			remote= (PIDaoRemote) context.lookup("gestion_suiviPI/PIDao!com.esprit.gestionPI.dao.PIDaoRemote");
		} catch (NamingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	}
	public com.esprit.gestionPI.persistence.PI getPi() {
		return pi;
	}
	public void setPi(com.esprit.gestionPI.persistence.PI pi) {
		this.pi = pi;
	}
}
